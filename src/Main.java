...
public class Main {
    ...
    static final Set<String> NON_TERMINALS = new HashSet<>(Arrays.asList(E, EP, T, TP, F));
    ...
    static boolean reconocer(List<String> tokens) {
        ...
        System.out.printf("%-28s %-20s %-25s%n", "PILA (tope→)", "ENTRADA (pos→)", "ACCIÓN");
        System.out.println("─".repeat(75));
    ...
    static List<String> tokenizar(String expresion) {
        ...
        while (i < expresion.length()) {
            ...
            switch (c) {
                ...
                case '*': tokens.add(TIMES);  break;
                case '/': tokens.add(DIV);    break;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("║    T' → * F T' | / F T' | ε                                             ║");
        System.out.println("║    F  → ( E ) | id | num                                                 ║");
        System.out.println("╚══════════════════════════════════════════════════════════════════════════╝\n");
